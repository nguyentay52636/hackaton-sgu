...
import { ChatMode } from '@/apis/types'
...
export default function HelpChat({ sessionId }: HelpChatProps) {
    ...
    const handleSendChat = async () => {
        ...
        // Simple placeholder response while backend integration is pending
        setTimeout(() => {
            setChatMessages((prev) => [
                ...prev,
                {
                    ...
                    role: "assistant",
                    content: chatMode === "simple"
                        ? "Tôi sẽ giúp bạn với câu hỏi này ngay khi có dữ liệu từ AI."
                        : "Chế độ chi tiết đang được phát triển. Vui lòng thử lại sau khi tính năng được cập nhật đầy đủ.",
                    timestamp: new Date(),
                },
            ])
